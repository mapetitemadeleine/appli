...
window.MPM_EXERCICES = [
  ...
  },
  {
    ...
    items: [
      ...
      { type: "choix", enonce: "« Où est ___ manteau ? », demande Odile à son mari Henri.", options: ["ta", "ton", "tes"], reponse: 1, note: "Odile tutoie son mari, et « manteau » est masculin : « ton »." },
  ...
  },
  {
    ...
    items: [
      ...
      { type: "choix", enonce: "« Que vous avez de grands bras ! » — « C'est pour mieux t'___, ma fille. »", options: ["embrasser", "adorer", "entasser"], reponse: 0, note: "Après « pour mieux », le verbe reste à l'infinitif : on ne le conjugue jamais." },
      { type: "choix", enonce: "« Que vous avez de grandes jambes ! » — « C'est pour mieux ___. »", options: ["courir", "grandir", "cueillir"], reponse: 0, note: "Toujours l'infinitif après « pour mieux »." },
      { type: "choix", enonce: "« Que vous avez de grandes oreilles ! » — « C'est pour mieux t'___. »", options: ["écouter", "attendre", "appeler"], reponse: 0, note: "Écouter, et non entendre : le loup fait semblant d'être attentif." },
      { type: "choix", enonce: "« Que vous avez de grandes dents ! » — « C'est pour mieux te ___ ! »", options: ["manger", "mener", "montrer"], reponse: 0, note: "La dernière réplique du conte." },
  ...
  },
  {
    ...
    items: [
      { type: "choix", enonce: "J'___ la pluie sur les volets.", options: ["entend", "entends", "entende"], reponse: 1, note: "J'entends, tu entends, il entend : le s est pour les deux premières personnes." },
