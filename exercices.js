...
window.MPM_EXERCICES = [
  {
    ...
    items: [
      ...
      { type: "saisie", enonce: "Le contraire de « prodigue » :", reponse: ["économe"], note: "Prodigue dépense sans compter ; économe garde." },
      { type: "saisie", enonce: "Le contraire de « éphémère » :", reponse: ["durable"], note: "Éphémère ne dure qu'un jour." },
      ...
      { type: "ecoute", enonce: "Écoutez, puis écrivez le verbe qui convient.", audio: "Le président va gracier un condamné.", reponse: ["gracier"], note: "Gracier un condamné : lui remettre sa peine." }
    ],
  ...
  },
  {
    ...
    items: [
      ...
      { type: "saisie", enonce: "Il pleut très fort : il pleut des ___", reponse: ["cordes", "des cordes"], note: "Il pleut des cordes." },
      { type: "saisie", enonce: "Ne pas venir à un rendez-vous : poser un ___", reponse: ["lapin", "un lapin"], note: "Poser un lapin." },
  ...
  },
  {
    ...
    items: [
      ...
      { type: "saisie", enonce: "Le serveur s'excuse : « Oh, toutes mes ___ »", reponse: ["excuses", "toutes mes excuses"], note: "Toutes mes excuses." },
  ...
  },
  {
    ...
    items: [
      { type: "saisie", enonce: "Contraire : « Le directeur reçoit quelqu'un ce matin. » → Le directeur ___ ce matin.", reponse: ["ne reçoit personne", "ne reçoit personne ce matin"], note: "Personne remplace quelqu'un, après le verbe." },
      ...
      { type: "saisie", enonce: "Contraire : « Mon frère a toujours raison. » → Mon frère ___ raison.", reponse: ["n'a jamais", "n'a jamais raison"], note: "Jamais s'installe entre l'auxiliaire et le participe." },
      ...
      { type: "saisie", enonce: "« Je me sens bien partout. » → Je ne me sens bien ___", reponse: ["nulle part"], note: "Nulle part se place après le verbe conjugué et son complément." },
      ...
      { type: "saisie", enonce: "Au passé composé : « Il ne vient plus jamais. » → Il ___ venu.", reponse: ["n'est plus jamais"], note: "Les deux adverbes se placent avant le participe." },
      { type: "ecoute", enonce: "Écoutez, puis répondez au négatif : « Avez-vous rencontré quelqu'un ? »", audio: "Avez-vous rencontré quelqu'un ce matin ?", reponse: ["non, je n'ai rencontré personne", "je n'ai rencontré personne"], note: "Personne se place après le participe passé." }
    ],
  ...
  },
  {
    ...
    items: [
      { type: "saisie", enonce: "Il faut que tu ___ (finir) tes devoirs avant le dîner.", reponse: ["finisses"], note: "Deuxième groupe : finisse, finisses, finisse…" },
      { type: "saisie", enonce: "Je veux que vous ___ (être) à l'heure demain matin.", reponse: ["soyez"], note: "Être : que je sois, que vous soyez." },
      { type: "saisie", enonce: "Bien qu'il ___ (faire) froid, elle sort sans manteau.", reponse: ["fasse"], note: "Bien que demande toujours le subjonctif." },
      { type: "saisie", enonce: "Je doute qu'ils ___ (savoir) la vérité.", reponse: ["sachent"], note: "Savoir : que je sache, qu'ils sachent." },
      { type: "saisie", enonce: "Il vaut mieux que tu ___ (prendre) le train.", reponse: ["prennes"], note: "Prendre : que je prenne, que nous prenions." },
      ...
      { type: "ecoute", enonce: "Écoutez et écrivez le verbe au subjonctif.", audio: "J'aimerais que nous allions au bord de la mer cet été.", reponse: ["allions", "nous allions"], note: "Aller : que nous allions." }
    ],
  ...
  },
  {
    ...
    items: [
      { type: "saisie", enonce: "Une personne qui part en vacances au mois de juillet est un ___", reponse: ["juillettiste", "un juillettiste"], note: "Et celle qui part en août est un aoûtien." },
      ...
      { type: "saisie", enonce: "La bande de terre le long de la mer : le ___", reponse: ["littoral", "le littoral"], note: "Le littoral." },
      { type: "saisie", enonce: "Ne rien faire, avec délices : le ___", reponse: ["farniente", "le farniente"], note: "De l'italien far niente." },
      ...
      { type: "saisie", enonce: "Les gouttelettes salées portées par le vent : les ___", reponse: ["embruns", "les embruns"], note: "Les embruns." },
      ...
      { type: "ecoute", enonce: "Écoutez et écrivez le mot qui manque.", audio: "Nous avons passé l'été en villégiature au bord de la mer.", reponse: ["villégiature", "en villégiature"], note: "La villégiature : le séjour de repos." }
    ],
  ...
  },
  {
    ...
    items: [
      ...
      { type: "saisie", enonce: "Cet après-midi, Julien va à la ___ avec les enfants.", reponse: ["piscine", "à la piscine", "la piscine"], note: "À la piscine." }
    ],
  ...
  },
  {
    ...
    items: [
      ...
      { type: "saisie", enonce: "Biographies : 38. Romans : 84. Il y a ___ lecteurs de biographies que de romans.", reponse: ["moins de", "moins"], note: "Moins de… que de…" },
      ...
      { type: "saisie", enonce: "Livres pratiques : 56. Bandes dessinées : 56. Il y a ___ lecteurs de livres pratiques que de bandes dessinées.", reponse: ["autant de", "autant"], note: "Autant de marque l'égalité." },
  ...
  },
  {
    ...
    items: [
      ...
      { type: "saisie", enonce: "A1 — Écrivez 1856 en toutes lettres.", reponse: ["mille huit cent cinquante-six"], note: "Cent et vingt ne prennent pas de s ici." },
      ...
      { type: "ecoute", enonce: "B2 — Écoutez et écrivez le mot manquant.", audio: "Il a agi avec une grande mansuétude envers son adversaire.", reponse: ["mansuétude"], note: "La mansuétude : la douceur indulgente." }
    ],
  ...
  },
  {
    ...
    items: [
      ...
      { type: "saisie", enonce: "Le chat pose sa ___ en jouant sur la pâte à tarte.", reponse: ["patte"], note: "La patte de l'animal, sans accent ; la pâte du boulanger, avec." },
      { type: "saisie", enonce: "Ton écharpe ? Elle est ___ , tu l'as oubliée sur le banc.", reponse: ["là"], note: "Là, adverbe de lieu, prend l'accent." },
      ...
      { type: "saisie", enonce: "Dès le mois de ___ , elle a fait son premier essai.", reponse: ["mai"], note: "Mai, le mois ; mais, la conjonction ; mets, du verbe mettre." },
      { type: "ecoute", enonce: "Écoutez et écrivez le dernier mot.", audio: "Elle a travaillé sans arrêt.", reponse: ["arrêt", "sans arrêt"], note: "Arrêt, avec un accent circonflexe et deux r." }
    ],
  ...
  },
  {
    ...
    items: [
      { type: "saisie", enonce: "la révolution → l'adjectif : ___", reponse: ["révolutionnaire"], note: "Suffixe -aire." },
      { type: "saisie", enonce: "le courage → l'adjectif : ___", reponse: ["courageux"], note: "Suffixe -eux." },
      { type: "saisie", enonce: "la province → l'adjectif : ___", reponse: ["provincial"], note: "Suffixe -al." },
      ...
      { type: "ecoute", enonce: "Écoutez et écrivez l'adjectif entendu.", audio: "Ce fut une victoire éclatante : un retour victorieux.", reponse: ["victorieux"], note: "la victoire → victorieux." }
    ],
  ...
  },
  {
    ...
    items: [
      { type: "saisie", enonce: "Hier, un imprévu ___ (survenir) pendant la réunion.", reponse: ["est survenu"], note: "Survenir se conjugue avec être." },
      { type: "saisie", enonce: "Les ingénieurs ___ (résoudre) enfin le problème.", reponse: ["ont résolu"], note: "Participe passé irrégulier : résolu." },
      { type: "saisie", enonce: "Après un long effort, elle ___ (atteindre) le sommet.", reponse: ["a atteint"], note: "Avec avoir, pas d'accord ici : le complément suit le verbe." },
      ...
      { type: "saisie", enonce: "Chaque hiver, nous ___ (voyager) vers la montagne.", reponse: ["voyagions"], note: "Imparfait : l'habitude, le décor." },
      { type: "saisie", enonce: "Futur simple — je (courir) : ___", reponse: ["courrai", "je courrai"], note: "Deux r au futur : courrai." },
      ...
      { type: "ecoute", enonce: "Écoutez, puis écrivez le verbe conjugué.", audio: "Elles recevront une lettre demain matin.", reponse: ["recevront", "elles recevront"], note: "Recevoir fait recevr- au futur." }
    ],
  ...
  },
  {
    ...
    items: [
      { type: "image", enonce: "Elle a des tentacules.", image: "img/1.png", reponse: ["une pieuvre", "la pieuvre", "pieuvre"], note: "Une pieuvre — on dit aussi un poulpe." },
      { type: "image", enonce: "Il dort en nageant.", image: "img/2.png", reponse: ["un requin", "le requin", "requin"], note: "Un requin." },
      { type: "image", enonce: "Elle est rouge et verte.", image: "img/3.png", reponse: ["une pastèque", "la pastèque", "pastèque"], note: "Une pastèque, le fruit de l'été." },
      { type: "image", enonce: "Quand il pleut, elle met ses…", image: "img/4.png", reponse: ["des bottes", "les bottes", "bottes"], note: "Des bottes — toujours au pluriel, comme les chaussures." },
      { type: "image", enonce: "Il plante un clou avec…", image: "img/5.png", reponse: ["un marteau", "le marteau", "marteau"], note: "Un marteau." },
      { type: "image", enonce: "Elle fait du miel.", image: "img/6.png", reponse: ["une abeille", "l'abeille", "abeille"], note: "Une abeille. Attention : l'abeille, avec élision." },
      { type: "ecoute", enonce: "Écoutez et écrivez le mot qui manque.", audio: "Il ferme son pantalon avec une ceinture.", reponse: ["une ceinture", "ceinture", "la ceinture"], note: "Une ceinture." },
      { type: "image", enonce: "Elle est rouge à points noirs.", image: "img/7.png", reponse: ["une coccinelle", "la coccinelle", "coccinelle"], note: "Une coccinelle, la bête à bon Dieu." }
    ],
  ...
  },
  {
    ...
    items: [
      { type: "saisie", enonce: "un journal → des ___", reponse: ["journaux"], note: "Les noms en -al font -aux." },
      { type: "saisie", enonce: "un bijou → des ___", reponse: ["bijoux"], note: "Bijou, caillou, chou, genou, hibou, joujou, pou prennent un x." },
      { type: "saisie", enonce: "un pneu → des ___", reponse: ["pneus"], note: "Pneu et bleu font exception aux mots en -eu." },
      { type: "saisie", enonce: "un œil → des ___", reponse: ["yeux"], note: "Pluriel irrégulier." },
      ...
      { type: "ecoute", enonce: "Écoutez et écrivez le pluriel du dernier mot.", audio: "Le vitrail bleu de la cathédrale. Au pluriel : les vitraux.", reponse: ["vitraux", "les vitraux"], note: "Vitrail suit la série travail, corail, émail." }
    ],
  ...
  },
  {
    ...
    items: [
      ...
      { type: "ecoute", enonce: "Écoutez : quel jour sommes-nous ?", audio: "Aujourd'hui, c'est samedi, jour de marché.", reponse: ["samedi"], note: "Samedi, jour de marché." }
    ],
  ...
  },
  {
    ...
    items: [
      { type: "saisie", enonce: "Sur le quai, le jeune Antoine ___ (vouloir) devenir marin.", reponse: ["veut"], note: "je veux, tu veux, il veut." },
      { type: "saisie", enonce: "« ___ -tu monter jusqu'en haut du mât ? » (savoir)", reponse: ["sais"], note: "je sais, tu sais, il sait." },
      { type: "saisie", enonce: "S'il veut s'engager, Antoine ___ (devoir) vivre sans confort.", reponse: ["doit"], note: "je dois, tu dois, il doit." },
      ...
      { type: "saisie", enonce: "Pendant la tempête, les marins n'ont pas ___ dormir. (pouvoir)", reponse: ["pu"], note: "Participe passé : pu." },
      { type: "saisie", enonce: "Antoine a ___ apprendre très vite à grimper. (devoir)", reponse: ["dû"], note: "Participe passé : dû, avec accent circonflexe." },
      { type: "ecoute", enonce: "Écoutez et écrivez le verbe conjugué.", audio: "Nous ne voulons pas retarder le départ, la marée n'attend pas.", reponse: ["voulons", "nous voulons"], note: "nous voulons, vous voulez, ils veulent." }
    ],
  ...
  },
  {
    ...
    items: [
      { type: "saisie", enonce: "le Portugal → il est ___", reponse: ["portugais"], note: "Et elle est portugaise." },
      { type: "saisie", enonce: "l'Autriche → elle est ___", reponse: ["autrichienne"], note: "La consonne double : autrichien, autrichienne." },
      ...
      { type: "saisie", enonce: "le Tchad → elle est ___", reponse: ["tchadienne"], note: "tchadien, tchadienne." },
      { type: "choix", enonce: "le Burkina Faso → il est…", options: ["burkinais", "burkinabè"], reponse: 1, note: "Burkinabè, invariable." },
      { type: "saisie", enonce: "la Corée → elle est ___", reponse: ["coréenne"], note: "coréen, coréenne." },
      { type: "saisie", enonce: "le Mexique → il est ___", reponse: ["mexicain"], note: "mexicain, mexicaine." },
      { type: "ecoute", enonce: "Écoutez et écrivez la nationalité au féminin.", audio: "Elle vient de Hongrie : elle est hongroise.", reponse: ["hongroise"], note: "hongrois, hongroise." }
    ],
  ...
  },
  {
    ...
    items: [
      { type: "saisie", enonce: "On l'ouvre pour se protéger du soleil : un ___", reponse: ["parasol", "un parasol"], note: "Un parasol." },
      { type: "saisie", enonce: "On les met aux pieds pour marcher sur le sable chaud : des ___", reponse: ["tongs", "des tongs"], note: "Des tongs." },
      { type: "saisie", enonce: "Si j'avais un parasol, je n' ___ (attraper) pas de coup de soleil.", reponse: ["attraperais"], note: "Après si + imparfait, le conditionnel." },
      ...
      { type: "saisie", enonce: "À ta place, je ___ (louer) aussi une chaise longue.", reponse: ["louerais"], note: "je louerais, tu louerais." },
      ...
      { type: "ecoute", enonce: "Écoutez et écrivez le verbe au conditionnel.", audio: "Avec un peu de crème solaire, tu pourrais rester au soleil.", reponse: ["pourrais", "tu pourrais"], note: "pouvoir → je pourrais." }
    ],
  ...
  },
  {
    ...
    items: [
      ...
      { type: "saisie", enonce: "Le malade gardera la chambre en attendant que la fièvre ___ (tomber).", reponse: ["tombe"], note: "En attendant que + subjonctif." },
      ...
      { type: "saisie", enonce: "Nul n'a pu le retenir ___ sa décision prise.", reponse: ["une fois"], note: "Une fois + participe." },
  ...
  },
  {
    ...
    items: [
      { type: "saisie", enonce: "Présent — nous (maigrir) : nous ___", reponse: ["maigrissons"], note: "Deuxième groupe : -issons au pluriel." },
      { type: "saisie", enonce: "Présent — ils (réunir) : ils ___", reponse: ["réunissent"], note: "-issent." },
      { type: "choix", enonce: "Présent — je (bâtir) :", options: ["je bâtis", "je bâtit", "je bâtie"], reponse: 0, note: "je bâtis, tu bâtis, il bâtit." },
      { type: "saisie", enonce: "Futur — vendredi, nous ___ (être) en vacances.", reponse: ["serons"], note: "être → je serai, nous serons." },
      { type: "saisie", enonce: "Futur — les enfants ___ (aller) à la piscine demain.", reponse: ["iront"], note: "aller → j'irai, ils iront." },
      { type: "saisie", enonce: "Futur — elle ___ (faire) un gâteau pour la fête.", reponse: ["fera"], note: "faire → je ferai, elle fera." },
      { type: "ecoute", enonce: "Écoutez et écrivez le verbe au futur.", audio: "Un jour, tu viendras chez nous.", reponse: ["viendras", "tu viendras"], note: "venir → je viendrai, tu viendras." }
    ],
  ...
  },
  {
    ...
    items: [
      { type: "saisie", enonce: "On le remplit d'eau pour donner à boire aux fleurs : un ___", reponse: ["arrosoir", "un arrosoir"], note: "Un arrosoir." },
      { type: "saisie", enonce: "On les met en terre au printemps : des ___", reponse: ["graines", "des graines"], note: "Des graines." },
      { type: "saisie", enonce: "Grande fleur jaune qui suit le soleil : un ___", reponse: ["tournesol", "un tournesol"], note: "Un tournesol : il tourne avec le soleil." },
      ...
      { type: "saisie", enonce: "Ma sœur ___ (rentrer) du jardin à la nuit tombée.", reponse: ["est rentrée"], note: "Rentrer, verbe de mouvement : être, et accord avec le sujet." },
      { type: "ecoute", enonce: "Écoutez et écrivez l'adjectif manquant.", audio: "Les chemins sont devenus plus courbes et la nature semblait plus libre.", reponse: ["courbes", "plus courbes"], note: "Le jardin anglais préfère la courbe à la ligne droite." }
    ],
  ...
  },
  {
    ...
    items: [
      ...
      { type: "saisie", enonce: "Le contraire de « construire » : ___", reponse: ["détruire"], note: "construire ≠ détruire." },
      { type: "saisie", enonce: "Le contraire de « avancer » : ___", reponse: ["reculer"], note: "avancer ≠ reculer." },
      { type: "saisie", enonce: "Le cri de la vache : ___", reponse: ["meugler"], note: "La vache meugle." },
      { type: "saisie", enonce: "Le cri du cheval : ___", reponse: ["hennir"], note: "Le cheval hennit." },
      { type: "choix", enonce: "La marmotte…", options: ["bêle", "siffle", "brait"], reponse: 1, note: "La marmotte siffle pour donner l'alerte." },
      { type: "ecoute", enonce: "Écoutez et écrivez le verbe manquant.", audio: "Quand on sonne à la porte du chalet, le chien aboie.", reponse: ["aboie"], note: "Le chien aboie." }
    ],
  ...
  },
  {
    ...
    items: [
      ...
      { type: "saisie", enonce: "Ma sœur ___ (rentrer) de la campagne dimanche.", reponse: ["est rentrée"], note: "Être + accord au féminin." },
      { type: "saisie", enonce: "Nous ___ (boire) de l'eau fraîche à la fontaine.", reponse: ["avons bu"], note: "boire → bu, avec avoir." },
      { type: "saisie", enonce: "Participe passé de « ouvrir » : ___", reponse: ["ouvert"], note: "ouvrir → ouvert." },
      { type: "saisie", enonce: "Participe passé de « vivre » : ___", reponse: ["vécu"], note: "vivre → vécu." },
      ...
      { type: "saisie", enonce: "Vous vous ___ (se lever) tôt pour les moissons.", reponse: ["êtes levés", "vous êtes levés"], note: "Pronominal : être, accord avec le sujet." },
      { type: "ecoute", enonce: "Écoutez et écrivez le verbe au passé composé.", audio: "Les nuages ont disparu avant midi.", reponse: ["ont disparu", "disparu"], note: "disparaître → disparu, avec avoir." }
    ],
  ...
  },
  {
    ...
    items: [
      { type: "saisie", enonce: "Le grand sac que l'on porte sur le dos : un ___", reponse: ["cartable", "un cartable"], note: "Un cartable." },
      { type: "saisie", enonce: "Le petit livre où l'on écrit ses leçons : un ___", reponse: ["cahier", "un cahier"], note: "Un cahier." },
      { type: "saisie", enonce: "La pause au milieu de la matinée : la ___", reponse: ["récréation", "la récréation"], note: "La récréation." },
      ...
      { type: "saisie", enonce: "Le matin, j' ___ (entrer) à l'école à huit heures.", reponse: ["entre"], note: "j'entre, tu entres, il entre." },
      { type: "saisie", enonce: "Nous ___ (ouvrir) nos livres.", reponse: ["ouvrons"], note: "nous ouvrons." },
      { type: "ecoute", enonce: "Écoutez et écrivez le mot manquant.", audio: "La maîtresse écrit au tableau.", reponse: ["tableau", "au tableau", "le tableau"], note: "Au tableau." }
    ],
  ...
  },
  {
    ...
    items: [
      ...
      { type: "saisie", enonce: "Hier, nous avons cuisiné des madeleines ___ deux heures.", reponse: ["pendant"], note: "Pendant : la durée d'une action terminée." },
      { type: "saisie", enonce: "J'ai appris cette recette ___ une semaine.", reponse: ["en"], note: "En : le temps qu'il a fallu pour réussir." },
      { type: "choix", enonce: "Ma sœur part à Lyon ___ huit jours.", options: ["pour", "en", "depuis"], reponse: 0, note: "Pour : la durée prévue." },
      { type: "ecoute", enonce: "Écoutez et écrivez l'indicateur de temps.", audio: "On joue aux boules depuis une heure et demie.", reponse: ["depuis"], note: "Depuis mesure une action commencée et qui dure." }
    ],
  ...
  },
  {
    ...
    items: [
      { type: "saisie", enonce: "Réponse : « J'habite à Tours. » Question : ___ habitez-vous ?", reponse: ["où"], note: "Où interroge sur le lieu." },
      ...
      { type: "saisie", enonce: "Avec « est-ce que » : vous vous êtes inscrit au cours ? → ___ vous vous êtes inscrit au cours ?", reponse: ["est-ce que"], note: "Est-ce que garde l'ordre sujet-verbe." },
      { type: "ecoute", enonce: "Écoutez et écrivez le mot interrogatif.", audio: "D'où venez-vous, madame ?", reponse: ["d'où", "dou"], note: "D'où : l'origine, le point de départ." }
    ],
  ...
  },
  {
    ...
    items: [
      ...
      { type: "saisie", enonce: "Un village : ___ vous souvenez-vous ?", reponse: ["duquel"], note: "de + lequel = duquel, en un seul mot." },
      { type: "saisie", enonce: "Ces falaises : ___ nous approchons-nous ?", reponse: ["desquelles"], note: "de + lesquelles = desquelles." },
